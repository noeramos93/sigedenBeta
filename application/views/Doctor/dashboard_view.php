    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<?=base_url()?>index.php/">SIGEDEN</a>
            </div>
        ...
        <aside id="leftsidebar" class="sidebar">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#modalUser"><i class="material-icons">person</i>Profile</a></li>
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="<?=base_url()?>index.php/Doctor/Home_D">
                            <i class="material-icons">home</i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>index.php/Paciente">
                            <i class="material-icons">person_add</i>
                            <span>Capturar Paciente</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>index.php/Busqueda">
                            <i class="material-icons">search</i>
                            <span>Busqueda Paciente</span>
                        </a>
                    </li>
